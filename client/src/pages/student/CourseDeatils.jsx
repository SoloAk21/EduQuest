...
function CourseDetails() {
  ...
  const discountedPrice = coursePrice - (coursePrice * discount) / 100;
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: courseDescription.slice(0, 200) }}
        />
        <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
          <p>{Math.floor(calculateRating(courseData))}</p>
          <div className="flex">
            {[...Array(5)].map((_, i) => (
              <img
                key={i}
          ...
          <p className="text-blue-600">
            ...
            {courseRatings.length === 1 ? "rating" : "ratings"})
          </p>
          <p>
        ...
        <p className="text-sm">
          Course by <span className="text-blue-600 underline">SoloAk</span>
        </p>
                      ...
                      <li key={idx} className="flex items-start gap-2 py-1">
                        ...
                        <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                          ...
                          <div className="flex gap-2">
                            ...
                            <p>
                              {humanizeDuration(
                                content.lectureDuration * 60 * 1000,
                                { units: ["h", "m"] }
                              )}
                            </p>
                          </div>
